...
const EditMenuModal = ({ productId, setProductId }) => {
  ...
  const onSave = async (updatedFormData) => {
    let imageUrl = updatedFormData.image;
      ...
      <div className="modal-overlay">
        <div className="modal-content">
          ...
          <form method='PUT' onSubmit={handleSubmit}>
            ...
            <label>
              Category:
              <select className="category-dropdown" name="category" value={updatedFormData.category} onChange={handleChange}>
            ...
            <label>
              ...
              {updatedFormData.image && <img src={updatedFormData.image} alt="Current" style={{ width: '100px', marginTop: '10px' }} />}
            </label>
