...
export const GenerateQR = () => {
    ...
    useEffect(() => {
        const fetchTables = async () => {
            try {
                const response = await axios.get(`${process.env.REACT_APP_BACKEND_URL}/app/tables`);
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await fetch(`${process.env.REACT_APP_BACKEND_URL}/app/restaurants/${restaurantId}/tables/${tableNumber}/generate_qr`, {
                method: 'GET',
            });
