                    ...
                    <div className='principal'>
                        ...
                        <div className='top-bottom-container'>
                            ...
                            >
                                ...
                                >
                                    <img src={mesa.icono} alt="Mesa" style={{ width: '50px', height: '50px' }} />
                                    ...
                                    {modoEdicion ? (
                                        <>
                                            ...
                                            <button className='girar-mesa' style={{ position: 'absolute', transform: 'translateX(-50%)', backgroundColor: 'red', color: 'white' }}>X</button>
                                        </>
                                    ) : (
                                        <div>{mesa.nombre}</div>
                                    )}
