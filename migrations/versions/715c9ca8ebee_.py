...
Revision ID: 715c9ca8ebee
Revises: a5f0934c1dbd
Create Date: 2024-07-05 12:15:18.633532
...
revision = '715c9ca8ebee'
down_revision = 'a5f0934c1dbd'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.ForeignKeyConstraint(['id_product'], ['product.id'], name='producttable_ibfk_1'),
    sa.ForeignKeyConstraint(['id_session'], ['table_session.id'], name='producttable_ibfk_2'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['id_invoice'], ['invoice.id'], name='invoicedetail_ibfk_1'),
    sa.ForeignKeyConstraint(['id_product'], ['product.id'], name='invoicedetail_ibfk_2'),
    sa.PrimaryKeyConstraint('id')
    )
